...
const RESOURCE_CONFIG: Record<ResourceType, ResourceConfig> = {
  post: { endpoint: 'post', label: 'Post' },
  event: { endpoint: 'event', label: 'Event' },
}
      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.content}>
          ...
          <div className={styles.header}>
            ...
            <h2 className={styles.title}>Delete {RESOURCE_CONFIG[resourceType].label}</h2>
          </div>
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  Delete {RESOURCE_CONFIG[resourceType].label}
                </>
              )}
            </button>
          </div>
