    ...
    const postsData: CreatePostDto[] = [
        {
            ...
            categoriesNames: ['programming', 'typescript', 'web-development']
        },
        {
            coverImageUrl: undefined,
            ...
            categoriesNames: ['backend', 'nestjs', 'typescript', 'frameworks']
        },
        {
            coverImageUrl: undefined,
            ...
            categoriesNames: ['database', 'typeorm', 'backend', 'nodejs']
        },
        {
            coverImageUrl: undefined,
        ...
        },
        {
            ...
            categoriesNames: ['security', 'authentication', 'backend', 'web-development']
        },
        {
            coverImageUrl: undefined,
        ...
        },
        {
            ...
            categoriesNames: ['react', 'frontend', 'javascript', 'web-development']
        },
        {
            coverImageUrl: undefined,
            ...
            categoriesNames: ['nextjs', 'react', 'full-stack', 'frameworks']
        },
        {
            coverImageUrl: undefined,
        ...
        },
        {
            ...
            categoriesNames: ['performance', 'web-development', 'frontend', 'optimization']
        },
        {
            coverImageUrl: undefined,
            ...
            categoriesNames: ['security', 'web-development', 'best-practices', 'backend']
        },
        {
            coverImageUrl: undefined,
        ...
        },
        {
            ...
            categoriesNames: ['database', 'performance', 'backend', 'optimization']
        },
        {
            coverImageUrl: undefined,
        ...
        },
        {
            ...
            categoriesNames: ['performance', 'backend', 'optimization', 'web-development']
        },
        {
            coverImageUrl: undefined,
